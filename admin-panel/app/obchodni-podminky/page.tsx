...
export const metadata = {
  ...
  description: 'Všeobecné obchodní podmínky společnosti NANO FUSION s.r.o. pro nátěry a čištění fasád, střech a dlažeb.'
}
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-20 px-4">
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-slate-100">
        ...
        <h1 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 font-heading">Všeobecné obchodní podmínky</h1>

        <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200 text-slate-700 text-sm mb-10 leading-relaxed">
          <p className="font-bold text-slate-900 text-base mb-2">NANO FUSION s.r.o.</p>
          <p>Pod Nádražím 370, 664 01 Bílovice nad Svitavou, Česká republika</p>
          <p className="mt-2">IČ: 29375363</p>
          <p>Web: <a href="https://www.nanofusion.cz" className="text-amber-600 font-bold hover:underline">www.nanofusion.cz</a> | E-mail: <a href="mailto:info@nanofusion.cz" className="text-amber-600 font-bold hover:underline">info@nanofusion.cz</a> | Tel: <a href="tel:+420774509409" className="text-amber-600 font-bold hover:underline">+420 774 509 409</a></p>
        </div>
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-700 text-base leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">2. Uzavření smlouvy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">3. Cena a platební podmínky</h2>
            <p className="mb-4">Ceny za poskytované služby jsou stanoveny dle aktuálního ceníku Zhotovitele nebo na základě individuální nabídky. Zákazník je povinen uhradit cenu za služby ve lhůtě stanovené ve faktuře.</p>

            <div className="space-y-4 pl-4 border-l-2 border-amber-500/30">
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">1. Splatnost faktur</h3>
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">2. Možnosti platebních metod</h3>
                <ul className="list-disc pl-5 space-y-1 mt-1 text-sm">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">3. Sankce za prodlení s platbou</h3>
                <ul className="list-disc pl-5 space-y-1 mt-1 text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">4. Odstoupení od smlouvy a výpověď smlouvy</h2>
            <div className="space-y-4 pl-4 border-l-2 border-amber-500/30">
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">1. Podmínky a postup pro odstoupení ze strany Zákazníka</h3>
                <ul className="list-disc pl-5 space-y-1 mt-1 text-sm">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">2. Podmínky a postup pro odstoupení ze strany Zhotovitele</h3>
                <ul className="list-disc pl-5 space-y-1 mt-1 text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">5. Práva a povinnosti Zhotovitele</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">6. Práva a povinnosti Zákazníka</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">7. Reklamace</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">8. Ochrana osobních údajů</h2>
            <p>Zhotovitel zpracovává osobní údaje Zákazníků v souladu s platnými právními předpisy. Podrobnosti naleznete v záložce <a href="/gdpr" className="text-amber-600 font-bold hover:underline">Ochrana osobních údajů (GDPR)</a>.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">9. Odpovědnost za škody</h2>
            <div className="space-y-4 pl-4 border-l-2 border-amber-500/30">
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">1. Limitace odpovědnosti Zhotovitele</h3>
                <ul className="list-disc pl-5 space-y-1 mt-1 text-sm">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">2. Povinnost Zákazníka nahradit škody</h3>
                <ul className="list-disc pl-5 space-y-1 mt-1 text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">10. Doba plnění</h2>
            <div className="space-y-4 pl-4 border-l-2 border-amber-500/30">
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">1. Přibližné termíny realizace</h3>
                <ul className="list-disc pl-5 space-y-1 mt-1 text-sm">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">2. Možnosti změn termínů a jejich důsledky</h3>
                <ul className="list-disc pl-5 space-y-1 mt-1 text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">11. Řešení sporů</h2>
            <div className="space-y-4 pl-4 border-l-2 border-amber-500/30">
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">1. Možnost mediace nebo arbitráže</h3>
                <p className="text-sm mt-1">V případě vzniku sporu mají obě strany možnost využít mediaci nebo arbitráž jako alternativní způsoby řešení sporů.</p>
              </div>
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wide">2. Příslušnost soudů</h3>
                <p className="text-sm mt-1">Pro případ soudního řešení sporů je příslušným soudem soud v místě sídla Zhotovitele.</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">12. Změny VOP</h2>
            <ul className="list-disc pl-5 space-y-1.5 text-sm">
              ...
              <li>Změny VOP budou zveřejněna na webových stránkách Zhotovitele a Zákazník bude informován prostřednictvím e-mailu.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">13. Závěrečná ustanovení</h2>
            ...
            <p className="font-bold text-slate-900 mt-4">Tyto VOP nabývají účinnosti dne 1.1.2024.</p>
          </section>
