...
function ArticleCard({ article }: { article: any }) {
  ...
  return (
    <Link 
      ...
      className="group/card flex flex-col bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 h-auto w-[85vw] md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.33rem)] shrink-0 snap-start"
    >
...
export function ArticlesCarousel({ articles }: { articles: any[] }) {
  ...
  return (
    <div className="relative group">
      ...
      <div 
        ref={scrollRef}
        className="flex overflow-x-auto gap-4 sm:gap-8 snap-x snap-mandatory hide-scrollbar pb-8 pt-4"
      >
